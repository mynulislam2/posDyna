    ...
    return (
        <div className='flex items-center justify-between h-20 w-ful shadow-md px-10 sticky top-0 '>
            ...
            <div className='flex items-center gap-8'>
                ...
                <div>
                    <svg id="message" className="relative"
                ...
                <div className='flex content-between gap-1 relative'>
                    <svg id="notifications" className="" 
                    onClick={() => {setisShowNotifi(!isShowNotifi);HandleMenu()}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
